  ...
  return [
    {
      table: 'categories',
      title: 'Categories',
      description: 'Main system categories used on home, search, and cases.',
    ...
    },
    {
      table: 'site_types',
      title: 'Site Types',
      description: 'Location or project type filters, such as office or factory.',
    ...
    },
    {
      table: 'door_types',
      title: 'Door Types',
      description: 'Door, entrance, or gate type filters.',
      supportsCategoryFields: false,
      supportsSortOrder: true,
      items: doorTypes,
    },
    {
      table: 'system_types',
      title: 'System Types',
      description: 'Primary technical system filters.',
      supportsCategoryFields: false,
      supportsSortOrder: true,
      items: systemTypes,
    },
    {
      table: 'tags',
      title: 'Tags',
      description: 'Reusable labels for case grouping.',
      supportsCategoryFields: false,
